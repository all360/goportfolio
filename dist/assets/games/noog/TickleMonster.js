...
ApplicationMain.embed = $hx_exports.openfl.embed = function(elementName,width,height,background) {
	...
	ApplicationMain.urlLoaders.set("assets/sounds/endYell.xmp",urlLoader);
	ApplicationMain.total++;
	var sound2 = haxe.io.Path.withoutExtension("assets/sounds/gameplay.mp3");
	if(!HxOverrides.remove(sounds,sound2)) ApplicationMain.total++;
	sounds.push(sound2);
	var sound3 = haxe.io.Path.withoutExtension("assets/sounds/gameplay.ogg");
	if(!HxOverrides.remove(sounds,sound3)) ApplicationMain.total++;
	sounds.push(sound3);
	var sound4 = haxe.io.Path.withoutExtension("assets/sounds/hopfinalAttack.mp3");
	if(!HxOverrides.remove(sounds,sound4)) ApplicationMain.total++;
	sounds.push(sound4);
	var sound5 = haxe.io.Path.withoutExtension("assets/sounds/hopfinalAttack.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/hopfinalAttack.xmp",urlLoader1);
	ApplicationMain.total++;
	var sound6 = haxe.io.Path.withoutExtension("assets/sounds/hopLaugh.mp3");
	if(!HxOverrides.remove(sounds,sound6)) ApplicationMain.total++;
	sounds.push(sound6);
	var sound7 = haxe.io.Path.withoutExtension("assets/sounds/hopLaugh.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/hopLaugh.xmp",urlLoader2);
	ApplicationMain.total++;
	var sound8 = haxe.io.Path.withoutExtension("assets/sounds/hopMiss.mp3");
	if(!HxOverrides.remove(sounds,sound8)) ApplicationMain.total++;
	sounds.push(sound8);
	var sound9 = haxe.io.Path.withoutExtension("assets/sounds/hopMiss.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/hopMiss.xmp",urlLoader3);
	ApplicationMain.total++;
	var sound10 = haxe.io.Path.withoutExtension("assets/sounds/hopTickleSpot.mp3");
	if(!HxOverrides.remove(sounds,sound10)) ApplicationMain.total++;
	sounds.push(sound10);
	var sound11 = haxe.io.Path.withoutExtension("assets/sounds/hopTickleSpot.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/hopTickleSpot.xmp",urlLoader4);
	ApplicationMain.total++;
	var sound12 = haxe.io.Path.withoutExtension("assets/sounds/introSound.mp3");
	if(!HxOverrides.remove(sounds,sound12)) ApplicationMain.total++;
	sounds.push(sound12);
	var sound13 = haxe.io.Path.withoutExtension("assets/sounds/introSound.ogg");
	if(!HxOverrides.remove(sounds,sound13)) ApplicationMain.total++;
	sounds.push(sound13);
	var sound14 = haxe.io.Path.withoutExtension("assets/sounds/introSound.wav");
	if(!HxOverrides.remove(sounds,sound14)) ApplicationMain.total++;
	sounds.push(sound14);
	var sound15 = haxe.io.Path.withoutExtension("assets/sounds/laugh1.mp3");
	if(!HxOverrides.remove(sounds,sound15)) ApplicationMain.total++;
	sounds.push(sound15);
	var sound16 = haxe.io.Path.withoutExtension("assets/sounds/laugh1.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/laugh1.xmp",urlLoader5);
	ApplicationMain.total++;
	var sound17 = haxe.io.Path.withoutExtension("assets/sounds/laugh2.mp3");
	if(!HxOverrides.remove(sounds,sound17)) ApplicationMain.total++;
	sounds.push(sound17);
	var sound18 = haxe.io.Path.withoutExtension("assets/sounds/laugh2.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/laugh2.xmp",urlLoader6);
	ApplicationMain.total++;
	var sound19 = haxe.io.Path.withoutExtension("assets/sounds/laugh3.mp3");
	if(!HxOverrides.remove(sounds,sound19)) ApplicationMain.total++;
	sounds.push(sound19);
	var sound20 = haxe.io.Path.withoutExtension("assets/sounds/laugh3.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/laugh3.xmp",urlLoader7);
	ApplicationMain.total++;
	var sound21 = haxe.io.Path.withoutExtension("assets/sounds/MonsterRoar.mp3");
	if(!HxOverrides.remove(sounds,sound21)) ApplicationMain.total++;
	sounds.push(sound21);
	var sound22 = haxe.io.Path.withoutExtension("assets/sounds/MonsterRoar.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/MonsterRoar.xmp",urlLoader8);
	ApplicationMain.total++;
	var sound23 = haxe.io.Path.withoutExtension("assets/sounds/_armorHit3.mp3");
	if(!HxOverrides.remove(sounds,sound23)) ApplicationMain.total++;
	sounds.push(sound23);
	var sound24 = haxe.io.Path.withoutExtension("assets/sounds/_armorHit3.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/_armorHit3.xmp",urlLoader9);
	ApplicationMain.total++;
	var sound25 = haxe.io.Path.withoutExtension("assets/sounds/_correct_hit.mp3");
	if(!HxOverrides.remove(sounds,sound25)) ApplicationMain.total++;
	sounds.push(sound25);
	var sound26 = haxe.io.Path.withoutExtension("assets/sounds/_correct_hit.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/_correct_hit.xmp",urlLoader10);
	ApplicationMain.total++;
	var sound27 = haxe.io.Path.withoutExtension("assets/sounds/_door.mp3");
	if(!HxOverrides.remove(sounds,sound27)) ApplicationMain.total++;
	sounds.push(sound27);
	var sound28 = haxe.io.Path.withoutExtension("assets/sounds/_door.ogg");
	...
	ApplicationMain.urlLoaders.set("assets/sounds/_door.xmp",urlLoader11);
	ApplicationMain.total++;
	var sound29 = haxe.io.Path.withoutExtension("assets/sounds/_doorClose.mp3");
	if(!HxOverrides.remove(sounds,sound29)) ApplicationMain.total++;
	sounds.push(sound29);
	var sound30 = haxe.io.Path.withoutExtension("assets/sounds/_doorClose.ogg");
	if(!HxOverrides.remove(sounds,sound30)) ApplicationMain.total++;
	sounds.push(sound30);
	var urlLoader12 = new openfl.net.URLLoader();
	urlLoader12.set_dataFormat(openfl.net.URLLoaderDataFormat.BINARY);
	ApplicationMain.urlLoaders.set("assets/sounds/_doorClose.xmp",urlLoader12);
	ApplicationMain.total++;
	var sound31 = haxe.io.Path.withoutExtension("assets/sounds/_gameOver.mp3");
	if(!HxOverrides.remove(sounds,sound31)) ApplicationMain.total++;
	sounds.push(sound31);
	var sound32 = haxe.io.Path.withoutExtension("assets/sounds/_gameOver.ogg");
	if(!HxOverrides.remove(sounds,sound32)) ApplicationMain.total++;
	sounds.push(sound32);
	var urlLoader13 = new openfl.net.URLLoader();
	urlLoader13.set_dataFormat(openfl.net.URLLoaderDataFormat.BINARY);
	ApplicationMain.urlLoaders.set("assets/sounds/_gameOver.xmp",urlLoader13);
	ApplicationMain.total++;
	var sound33 = haxe.io.Path.withoutExtension("assets/sounds/_running.mp3");
	if(!HxOverrides.remove(sounds,sound33)) ApplicationMain.total++;
	sounds.push(sound33);
	var sound34 = haxe.io.Path.withoutExtension("assets/sounds/_running.ogg");
	if(!HxOverrides.remove(sounds,sound34)) ApplicationMain.total++;
	sounds.push(sound34);
	var urlLoader14 = new openfl.net.URLLoader();
	urlLoader14.set_dataFormat(openfl.net.URLLoaderDataFormat.BINARY);
	ApplicationMain.urlLoaders.set("assets/sounds/_running.xmp",urlLoader14);
	ApplicationMain.total++;
	var sound35 = haxe.io.Path.withoutExtension("assets/sounds/_wrong.mp3");
	if(!HxOverrides.remove(sounds,sound35)) ApplicationMain.total++;
	sounds.push(sound35);
	var sound36 = haxe.io.Path.withoutExtension("assets/sounds/_wrong.ogg");
	if(!HxOverrides.remove(sounds,sound36)) ApplicationMain.total++;
	sounds.push(sound36);
	var urlLoader15 = new openfl.net.URLLoader();
	urlLoader15.set_dataFormat(openfl.net.URLLoaderDataFormat.BINARY);
	ApplicationMain.urlLoaders.set("assets/sounds/_wrong.xmp",urlLoader15);
	ApplicationMain.total++;
	var image19 = new Image();
	id = "assets/spaceBg.png";
	ApplicationMain.images.set(id,image19);
	image19.onload = ApplicationMain.image_onLoad;
	image19.src = id;
	ApplicationMain.total++;
	var image20 = new Image();
	id = "assets/spaceMonsterAnimation7.png";
	ApplicationMain.images.set(id,image20);
	image20.onload = ApplicationMain.image_onLoad;
	image20.src = id;
	ApplicationMain.total++;
	var image21 = new Image();
	id = "assets/spaceMonsterJumpAnimation.png";
	ApplicationMain.images.set(id,image21);
	image21.onload = ApplicationMain.image_onLoad;
	image21.src = id;
	ApplicationMain.total++;
	var sound37 = haxe.io.Path.withoutExtension("sounds/laugh1.mp3");
	if(!HxOverrides.remove(sounds,sound37)) ApplicationMain.total++;
	sounds.push(sound37);
	var sound38 = haxe.io.Path.withoutExtension("sounds/laugh2.mp3");
	if(!HxOverrides.remove(sounds,sound38)) ApplicationMain.total++;
	sounds.push(sound38);
	var sound39 = haxe.io.Path.withoutExtension("sounds/laugh3.mp3");
	if(!HxOverrides.remove(sounds,sound39)) ApplicationMain.total++;
	sounds.push(sound39);
	var sound40 = haxe.io.Path.withoutExtension("sounds/MonsterRoar.mp3");
	if(!HxOverrides.remove(sounds,sound40)) ApplicationMain.total++;
	sounds.push(sound40);
	var sound41 = haxe.io.Path.withoutExtension("sounds/endYell.mp3");
	if(!HxOverrides.remove(sounds,sound41)) ApplicationMain.total++;
	sounds.push(sound41);
	var sound42 = haxe.io.Path.withoutExtension("sounds/gameplay.mp3");
	if(!HxOverrides.remove(sounds,sound42)) ApplicationMain.total++;
	sounds.push(sound42);
	var sound43 = haxe.io.Path.withoutExtension("sounds/introSound.mp3");
	if(!HxOverrides.remove(sounds,sound43)) ApplicationMain.total++;
	sounds.push(sound43);
	var sound44 = haxe.io.Path.withoutExtension("sounds/_armorHit3.mp3");
	if(!HxOverrides.remove(sounds,sound44)) ApplicationMain.total++;
	sounds.push(sound44);
	var sound45 = haxe.io.Path.withoutExtension("sounds/_correct_hit.mp3");
	if(!HxOverrides.remove(sounds,sound45)) ApplicationMain.total++;
	sounds.push(sound45);
	var sound46 = haxe.io.Path.withoutExtension("sounds/_door.mp3");
	if(!HxOverrides.remove(sounds,sound46)) ApplicationMain.total++;
	sounds.push(sound46);
	var sound47 = haxe.io.Path.withoutExtension("sounds/_doorClose.mp3");
	if(!HxOverrides.remove(sounds,sound47)) ApplicationMain.total++;
	sounds.push(sound47);
	var sound48 = haxe.io.Path.withoutExtension("sounds/_gameOver.mp3");
	if(!HxOverrides.remove(sounds,sound48)) ApplicationMain.total++;
	sounds.push(sound48);
	var sound49 = haxe.io.Path.withoutExtension("sounds/_running.mp3");
	if(!HxOverrides.remove(sounds,sound49)) ApplicationMain.total++;
	sounds.push(sound49);
	var sound50 = haxe.io.Path.withoutExtension("sounds/_wrong.mp3");
	if(!HxOverrides.remove(sounds,sound50)) ApplicationMain.total++;
	sounds.push(sound50);
	var sound51 = haxe.io.Path.withoutExtension("sounds/hopLaugh.mp3");
	if(!HxOverrides.remove(sounds,sound51)) ApplicationMain.total++;
	sounds.push(sound51);
	var sound52 = haxe.io.Path.withoutExtension("sounds/hopMiss.mp3");
	if(!HxOverrides.remove(sounds,sound52)) ApplicationMain.total++;
	sounds.push(sound52);
	var sound53 = haxe.io.Path.withoutExtension("sounds/hopTickleSpot.mp3");
	if(!HxOverrides.remove(sounds,sound53)) ApplicationMain.total++;
	sounds.push(sound53);
	var sound54 = haxe.io.Path.withoutExtension("sounds/hopfinalAttack.mp3");
	if(!HxOverrides.remove(sounds,sound54)) ApplicationMain.total++;
	sounds.push(sound54);
	var sound55 = haxe.io.Path.withoutExtension("sounds/laugh1.ogg");
	if(!HxOverrides.remove(sounds,sound55)) ApplicationMain.total++;
	sounds.push(sound55);
	var sound56 = haxe.io.Path.withoutExtension("sounds/laugh2.ogg");
	if(!HxOverrides.remove(sounds,sound56)) ApplicationMain.total++;
	sounds.push(sound56);
	var sound57 = haxe.io.Path.withoutExtension("sounds/laugh3.ogg");
	if(!HxOverrides.remove(sounds,sound57)) ApplicationMain.total++;
	sounds.push(sound57);
	var sound58 = haxe.io.Path.withoutExtension("sounds/MonsterRoar.ogg");
	if(!HxOverrides.remove(sounds,sound58)) ApplicationMain.total++;
	sounds.push(sound58);
	var sound59 = haxe.io.Path.withoutExtension("sounds/endYell.ogg");
	if(!HxOverrides.remove(sounds,sound59)) ApplicationMain.total++;
	sounds.push(sound59);
	var sound60 = haxe.io.Path.withoutExtension("sounds/gameplay.ogg");
	if(!HxOverrides.remove(sounds,sound60)) ApplicationMain.total++;
	sounds.push(sound60);
	var sound61 = haxe.io.Path.withoutExtension("sounds/introSound.ogg");
	if(!HxOverrides.remove(sounds,sound61)) ApplicationMain.total++;
	sounds.push(sound61);
	var sound62 = haxe.io.Path.withoutExtension("sounds/_armorHit3.ogg");
	if(!HxOverrides.remove(sounds,sound62)) ApplicationMain.total++;
	sounds.push(sound62);
	var sound63 = haxe.io.Path.withoutExtension("sounds/_correct_hit.ogg");
	if(!HxOverrides.remove(sounds,sound63)) ApplicationMain.total++;
	sounds.push(sound63);
	var sound64 = haxe.io.Path.withoutExtension("sounds/_door.ogg");
	if(!HxOverrides.remove(sounds,sound64)) ApplicationMain.total++;
	sounds.push(sound64);
	var sound65 = haxe.io.Path.withoutExtension("sounds/_doorClose.ogg");
	if(!HxOverrides.remove(sounds,sound65)) ApplicationMain.total++;
	sounds.push(sound65);
	var sound66 = haxe.io.Path.withoutExtension("sounds/_gameOver.ogg");
	if(!HxOverrides.remove(sounds,sound66)) ApplicationMain.total++;
	sounds.push(sound66);
	var sound67 = haxe.io.Path.withoutExtension("sounds/_running.ogg");
	if(!HxOverrides.remove(sounds,sound67)) ApplicationMain.total++;
	sounds.push(sound67);
	var sound68 = haxe.io.Path.withoutExtension("sounds/_wrong.ogg");
	if(!HxOverrides.remove(sounds,sound68)) ApplicationMain.total++;
	sounds.push(sound68);
	var sound69 = haxe.io.Path.withoutExtension("sounds/hopLaugh.ogg");
	if(!HxOverrides.remove(sounds,sound69)) ApplicationMain.total++;
	sounds.push(sound69);
	var sound70 = haxe.io.Path.withoutExtension("sounds/hopMiss.ogg");
	if(!HxOverrides.remove(sounds,sound70)) ApplicationMain.total++;
	sounds.push(sound70);
	var sound71 = haxe.io.Path.withoutExtension("sounds/hopTickleSpot.ogg");
	if(!HxOverrides.remove(sounds,sound71)) ApplicationMain.total++;
	sounds.push(sound71);
	var sound72 = haxe.io.Path.withoutExtension("sounds/hopfinalAttack.ogg");
	if(!HxOverrides.remove(sounds,sound72)) ApplicationMain.total++;
	sounds.push(sound72);
	if(ApplicationMain.total == 0) ApplicationMain.start(); else {
		var $it0 = ApplicationMain.urlLoaders.keys();
		while( $it0.hasNext() ) {
			var path = $it0.next();
			var urlLoader16 = ApplicationMain.urlLoaders.get(path);
			urlLoader16.addEventListener("complete",ApplicationMain.loader_onComplete);
			urlLoader16.load(new openfl.net.URLRequest(path));
		}
		var _g = 0;
		while(_g < sounds.length) {
			var soundName = sounds[_g];
			++_g;
			var sound73 = new openfl.media.Sound();
			sound73.addEventListener(openfl.events.Event.COMPLETE,ApplicationMain.sound_onComplete);
			sound73.addEventListener(openfl.events.IOErrorEvent.IO_ERROR,ApplicationMain.sound_onIOError);
			sound73.load(new openfl.net.URLRequest(soundName + ".ogg"));
		}
	}
};
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(hasMain) Reflect.callMethod(Main,Reflect.field(Main,"main"),[]); else {
		...
		if(js.Boot.__instanceof(instance,openfl.display.DisplayObject)) openfl.Lib.current.addChild(instance); else {
			haxe.Log.trace("Error: No entry point found",{ fileName : "ApplicationMain.hx", lineNumber : 1118, className : "ApplicationMain", methodName : "preloader_onComplete"});
			haxe.Log.trace("If you are using DCE with a static main, you may need to @:keep the function",{ fileName : "ApplicationMain.hx", lineNumber : 1119, className : "ApplicationMain", methodName : "preloader_onComplete"});
		}
	}
};
...
var Main = function() {
	this._isMoonBgCreated = false;
	this._cardHolder = new openfl.display.Sprite();
	this._gameHolder = new openfl.display.Sprite();
...
Main.prototype = $extend(openfl.display.Sprite.prototype,{
	gameOver: function() {
		this._gameHolder.removeEventListener(openfl.events.Event.ENTER_FRAME,$bind(this,this.onEnterFrame));
		this.addChild(this._cardHolder);
		if(Main.LEVEL == 2) this._cardManager.showYouLostB(); else this._cardManager.showYouLost();
	}
	,passLevel: function() {
		this._gameHolder.removeEventListener(openfl.events.Event.ENTER_FRAME,$bind(this,this.onEnterFrame));
		this.addChild(this._cardHolder);
		motion.Actuate.timer(2).onComplete($bind(this,this.clearLevel));
		Main.LEVEL++;
		var _g = Main.LEVEL;
		switch(_g) {
		case 1:
			this._cardManager.showLevelTwoCard();
			break;
		case 2:
			this._cardManager.showLevelThreeCard();
			break;
		case 3:
			this._cardManager.showLevelFourCard();
			Main.LEVEL = 0;
			break;
		}
	}
	,restartLevel: function(e) {
		var _g = Main.LEVEL;
		switch(_g) {
		case 0:
			this.buildLevelOne();
		...
		case 1:
			...
			break;
		case 2:
			this.buildLevelThree();
			break;
		}
	}
	,startNextLevel: function(e) {
		var _g = Main.LEVEL;
		switch(_g) {
		case 1:
			this.buildLevelTwo();
	...
	,added: function(e) {
		...
		this.addChild(this._gameHolder);
		this.buildGame();
		this._gameHolder.set_alpha(0);
		this.addChild(this._cardHolder);
		this._cardManager = new cards.CardManager(this);
		this._cardManager.showFreakyBeasts();
	}
	,buildGame: function() {
		this.createRoomBg();
		this._door = new props.Door();
		this._gameHolder.addChild(this._door);
		this._scoreBoard = new points.Scoreboard(this);
	}
	,clearLevel: function() {
		if(this._monster != null) {
			motion.Actuate.stop(this,null,false,false);
			motion.Actuate.stop(this._monster,null,false,false);
			while(this._monster.get_numChildren() > 0) this._monster.removeChildAt(0);
			this._gameHolder.removeChild(this._monster);
			this._monster = null;
		}
	}
	,buildLevelOne: function() {
		this._monster = new monsters.MonsterA();
		this._gameHolder.addChild(this._monster);
		this._monster.setBehavior(new behaviors.BehaviorA(this._monster,this._door,this._scoreBoard,this));
		this.runGame();
	}
	,buildLevelTwo: function() {
		this._monster = new monsters.MonsterB();
		this._gameHolder.addChild(this._monster);
		this._monster.setBehavior(new behaviors.BehaviorB(this._monster,this._door,this._scoreBoard,this));
		this.runGame();
	}
	,buildLevelThree: function() {
		this.createMoonBg();
		this._monster = new monsters.MonsterC();
		this._gameHolder.addChild(this._monster);
		this._monster.setBehavior(new behaviors.BehaviorC(this._monster,null,this._scoreBoard,this));
		this.runGame();
	}
	,runGame: function() {
		motion.Actuate.tween(this._gameHolder,1,{ alpha : 1});
		this._monster.getBehavior().runOutDoor();
		this._gameHolder.addEventListener(openfl.events.Event.ENTER_FRAME,$bind(this,this.onEnterFrame));
		this.removeChild(this._cardHolder);
	}
	,onEnterFrame: function(e) {
		if(this._door != null) this._monster.onUpdateFrame(e);
		if(this._door != null) this._door.onUpdateFrame(e);
	}
	,playMusic: function(isInto) {
		if(isInto == null) isInto = false;
		if(isInto == true) {
			if(this._musicSC2 != null) this._musicSC2.stop();
			if(this._music1 == null) this._music1 = openfl.Assets.getSound("intro");
			this._musicSC1 = this._music1.play(0,999,new openfl.media.SoundTransform(.4));
		} else {
			if(this._musicSC1 != null) this._musicSC1.stop();
			if(this._music2 == null) this._music2 = openfl.Assets.getSound("theme");
			this._musicSC2 = this._music2.play(0,999,new openfl.media.SoundTransform(.4));
		}
	}
	,createRoomBg: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/monsterAnimationBg5.png");
		this._bgBmp = new openfl.display.Bitmap(bitmapData);
		this._bgBmp.set_width(1024);
		this._bgBmp.set_height(768);
		this._bgBmp.smoothing = true;
		this._bgBmp.cacheAsBitmap = true;
		this._bgBmp.set_alpha(0);
		motion.Actuate.tween(this._bgBmp,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut());
		this._gameHolder.addChild(this._bgBmp);
	}
	,createMoonBg: function() {
		if(this._isMoonBgCreated == false) {
			this._gameHolder.removeChild(this._door);
			this._gameHolder.removeChild(this._bgBmp);
			var bitmapData = openfl.Assets.getBitmapData("assets/spaceBg.png");
			this._bgBmp = new openfl.display.Bitmap(bitmapData);
			this._bgBmp.set_width(1024);
			this._bgBmp.set_height(768);
			this._bgBmp.smoothing = true;
			...
			this._bgBmp.set_alpha(0);
			motion.Actuate.tween(this._bgBmp,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut());
			this._gameHolder.addChildAt(this._bgBmp,0);
			this._isMoonBgCreated = true;
		}
	}
...
var DefaultAssetLibrary = function() {
	...
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.IMAGE);
	id = "assets/sounds/endYell.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/endYell.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/endYell.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/gameplay.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/gameplay.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/hopfinalAttack.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/hopfinalAttack.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/hopfinalAttack.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/hopLaugh.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/hopLaugh.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/hopLaugh.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/hopMiss.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/hopMiss.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/hopMiss.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/hopTickleSpot.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/hopTickleSpot.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/hopTickleSpot.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/introSound.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/introSound.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/introSound.wav";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/laugh1.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/laugh1.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/laugh1.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/laugh2.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/laugh2.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/laugh2.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/laugh3.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/laugh3.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/laugh3.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/MonsterRoar.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/MonsterRoar.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/MonsterRoar.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/_armorHit3.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/_armorHit3.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/_armorHit3.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/_correct_hit.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/_correct_hit.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/_correct_hit.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/_door.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/_door.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/_door.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/_doorClose.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/_doorClose.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/_doorClose.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/_gameOver.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/_gameOver.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/_gameOver.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/_running.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/_running.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/_running.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/sounds/_wrong.mp3";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "assets/sounds/_wrong.ogg";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.SOUND);
	id = "assets/sounds/_wrong.xmp";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/spaceBg.png";
	this.path.set(id,id);
	...
	this.type.set(id,openfl.AssetType.IMAGE);
	id = "sound1";
	this.path.set(id,"sounds/laugh1.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound2";
	this.path.set(id,"sounds/laugh2.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound3";
	this.path.set(id,"sounds/laugh3.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound4";
	this.path.set(id,"sounds/MonsterRoar.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound5";
	this.path.set(id,"sounds/endYell.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "theme";
	this.path.set(id,"sounds/gameplay.mp3");
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "intro";
	this.path.set(id,"sounds/introSound.mp3");
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "sound6";
	this.path.set(id,"sounds/_armorHit3.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound7";
	this.path.set(id,"sounds/_correct_hit.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound8";
	this.path.set(id,"sounds/_door.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound9";
	this.path.set(id,"sounds/_doorClose.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound10";
	this.path.set(id,"sounds/_gameOver.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound11";
	this.path.set(id,"sounds/_running.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound12";
	this.path.set(id,"sounds/_wrong.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound13";
	this.path.set(id,"sounds/hopLaugh.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound14";
	this.path.set(id,"sounds/hopMiss.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound15";
	this.path.set(id,"sounds/hopTickleSpot.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound16";
	this.path.set(id,"sounds/hopfinalAttack.mp3");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound1";
	this.path.set(id,"sounds/laugh1.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound2";
	this.path.set(id,"sounds/laugh2.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound3";
	this.path.set(id,"sounds/laugh3.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound4";
	this.path.set(id,"sounds/MonsterRoar.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound5";
	this.path.set(id,"sounds/endYell.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "theme";
	this.path.set(id,"sounds/gameplay.ogg");
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "intro";
	this.path.set(id,"sounds/introSound.ogg");
	this.type.set(id,openfl.AssetType.MUSIC);
	id = "sound6";
	this.path.set(id,"sounds/_armorHit3.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound7";
	this.path.set(id,"sounds/_correct_hit.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound8";
	this.path.set(id,"sounds/_door.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound9";
	this.path.set(id,"sounds/_doorClose.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound10";
	this.path.set(id,"sounds/_gameOver.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound11";
	this.path.set(id,"sounds/_running.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound12";
	this.path.set(id,"sounds/_wrong.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound13";
	this.path.set(id,"sounds/hopLaugh.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound14";
	this.path.set(id,"sounds/hopMiss.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound15";
	this.path.set(id,"sounds/hopTickleSpot.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
	id = "sound16";
	this.path.set(id,"sounds/hopfinalAttack.ogg");
	this.type.set(id,openfl.AssetType.SOUND);
};
...
Preloader.prototype = $extend(NMEPreloader.prototype,{
	createBg: function() {
		var bitmapData = new openfl.display.BitmapData(1024,768,false,597004);
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.set_alpha(.5);
...
var behaviors = {};
behaviors.AbstractBehavior = function(monster,door,scoreBoard,main) {
	this._speed = 2.5;
	this._main = main;
	this._door = door;
...
$hxClasses["behaviors.AbstractBehavior"] = behaviors.AbstractBehavior;
behaviors.AbstractBehavior.__name__ = ["behaviors","AbstractBehavior"];
behaviors.AbstractBehavior.prototype = {
	missedTickleSpot: function() {
		this.pauseMotion(2.5);
		this._scoreBoard.addWrongSpotHit();
		this.playSound("sound12");
	}
	,getScoreBooard: function() {
		return this._scoreBoard;
	}
	,getMain: function() {
		return this._main;
	}
	,hitTickleSpot: function() {
		if(this._scoreBoard.getTickleHitCount() == 2) motion.Actuate.pause(this._monster); else this.pauseMotion(.75);
		this._scoreBoard.addTickleHit();
		this.playSound("sound7");
	}
	,pauseMotion: function(time) {
		motion.Actuate.pause(this._monster);
		motion.Actuate.timer(time).onComplete($bind(this,this.resumeMotion));
	}
	,resumeMotion: function() {
		motion.Actuate.resume(this._monster);
	}
	,reset: function() {
		this._door.showBehavior("closeState");
	}
	,runOutDoor: function() {
		this.reset();
		this.setMask();
		this._monster.showBehavior("runSide");
		this._monster.displaySideTickleSpot();
		this._monster.set_x(850);
		this._monster.set_y(475);
		this._monster.set_scaleX(1);
		this._monster.set_scaleY(1);
		this._monster.getChildAt(0).set_scaleX(.6);
		this._monster.getChildAt(0).set_scaleY(.6);
		var delayTime = this.randomRange(1,9) * .1 + 1;
		motion.Actuate.tween(this._monster,.5,{ x : 500, y : 475}).onComplete($bind(this,this.createFrontAnimation)).ease(motion.easing.Quad.get_easeOut()).delay(delayTime);
		motion.Actuate.timer(delayTime * .9).onComplete($bind(this,this.openDoor));
		motion.Actuate.timer(delayTime * 1.9).onComplete($bind(this,this.closeDoor));
	}
	,playSound: function(name) {
		var sound = openfl.Assets.getSound(name);
		sound.play();
	}
	,openDoor: function() {
		this._door.showBehavior("open");
		this.playSound("sound8");
	}
	,closeDoor: function() {
		this._door.showBehavior("close");
		this.playSound("sound9");
	}
	,randomDirection: function() {
		var num = this.randomRange(1,4);
		switch(num) {
		case 1:
			this.createSideAnimationRight();
			break;
		case 2:
			this.createSideAnimationLeft();
			break;
		default:
			this.createFrontAnimationExit();
		}
	}
	,createFrontAnimation: function() {
		this.playSound("sound11");
		this.removeMask();
		var xPos = this.randomRange(100,900);
		this._monster.displayFrontTickleSpot();
		this._monster.showBehavior("runfront");
		motion.Actuate.tween(this._monster.getChildAt(0),this._speed,{ scaleX : 1.25, scaleY : 1.25});
		motion.Actuate.tween(this._monster,this._speed,{ x : xPos, y : 550}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.randomDirection));
	}
	,createFrontAnimationB: function() {
		this.playSound("sound11");
		var xPos = this.randomRange(100,900);
		this._monster.displayFrontTickleSpot();
		this._monster.showBehavior("runfront");
	...
	,createSideAnimationRight: function() {
		this._monster.showBehavior("runSide");
		this._monster.displaySideTickleSpot();
		this._monster.set_scaleX(-1);
		motion.Actuate.tween(this._monster,this._speed,{ x : this.randomRange(700,900)}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.createFrontAnimationB));
	}
	,createSideAnimationLeft: function() {
		this._monster.showBehavior("runSide");
		this._monster.displaySideTickleSpot();
		this._monster.set_scaleX(1);
		motion.Actuate.tween(this._monster,this._speed,{ x : this.randomRange(100,250)}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.createFrontAnimationB));
	}
	,createFrontAnimationExit: function() {
		this.playSound("sound11");
		this._monster.showBehavior("runSide");
		this._monster.displaySideTickleSpot();
		this._monster.set_scaleX(1);
		motion.Actuate.tween(this._monster,this._speed,{ x : -200}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.runOutDoor));
	}
	,randomRange: function(minNum,maxNum) {
		return Math.floor(Math.random() * (maxNum - minNum + 1)) + minNum;
	}
	,removeMask: function() {
		this._main.removeChild(this._bitmapMask);
		this._monster.set_mask(null);
	}
	,setMask: function() {
		this._main.addChild(this._bitmapMask);
		this._monster.set_mask(this._bitmapMask);
	}
	,createBgMask: function() {
		var bitmapData = new openfl.display.BitmapData(655,768,false,16777215);
		this._bitmapMask = new openfl.display.Bitmap(bitmapData);
	}
	,__class__: behaviors.AbstractBehavior
};
behaviors.ArmorBehavior = function() {
	openfl.display.Sprite.call(this);
};
$hxClasses["behaviors.ArmorBehavior"] = behaviors.ArmorBehavior;
behaviors.ArmorBehavior.__name__ = ["behaviors","ArmorBehavior"];
behaviors.ArmorBehavior.__super__ = openfl.display.Sprite;
behaviors.ArmorBehavior.prototype = $extend(openfl.display.Sprite.prototype,{
	removeArm: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/armor/armor1.png");
		this._armRight = new openfl.display.Bitmap(bitmapData);
		this.addChild(this._armRight);
		this._armRight.smoothing = true;
		this._armRight.set_y(0);
		var bitmapData2 = openfl.Assets.getBitmapData("assets/armor/armor0.png");
		this._armLeft = new openfl.display.Bitmap(bitmapData2);
		this.addChild(this._armLeft);
		this._armLeft.smoothing = true;
		this._armLeft.set_x(50);
		this._armLeft.set_y(0);
		motion.Actuate.tween(this._armLeft,1,{ y : 300, x : 300, rotation : 400, scaleX : 2, scaleY : 2}).ease(motion.easing.Quad.get_easeOut());
		motion.Actuate.tween(this._armRight,1,{ y : 360, x : -300, rotation : 200, scaleX : 2, scaleY : 2}).ease(motion.easing.Quad.get_easeOut());
		motion.Actuate.timer(1).onComplete($bind(this,this.onArmComplete));
	}
	,onArmComplete: function() {
		this._armRight.set_visible(false);
		this._armLeft.set_visible(false);
	}
	,removeBody: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/armor/armor2.png");
		this._body = new openfl.display.Bitmap(bitmapData);
		this.addChild(this._body);
		this._body.smoothing = true;
		this._body.set_y(120);
		this._body.set_scaleX(.5);
		this._body.set_scaleY(.5);
		motion.Actuate.tween(this._body,2,{ y : 350, x : 500, rotation : 500, scaleX : 2.5, scaleY : 2.5}).ease(motion.easing.Quad.get_easeOut());
		motion.Actuate.timer(1).onComplete($bind(this,this.onbodyComplete));
	}
	,onbodyComplete: function() {
		this._body.set_visible(false);
	}
	,__class__: behaviors.ArmorBehavior
});
behaviors.BehaviorA = function(monster,door,scoreBoard,main) {
	behaviors.AbstractBehavior.call(this,monster,door,scoreBoard,main);
};
$hxClasses["behaviors.BehaviorA"] = behaviors.BehaviorA;
behaviors.BehaviorA.__name__ = ["behaviors","BehaviorA"];
behaviors.BehaviorA.__super__ = behaviors.AbstractBehavior;
behaviors.BehaviorA.prototype = $extend(behaviors.AbstractBehavior.prototype,{
	__class__: behaviors.BehaviorA
});
behaviors.BehaviorB = function(monster,door,scoreBoard,main) {
	behaviors.AbstractBehavior.call(this,monster,door,scoreBoard,main);
	this._speed = 1.8;
};
$hxClasses["behaviors.BehaviorB"] = behaviors.BehaviorB;
behaviors.BehaviorB.__name__ = ["behaviors","BehaviorB"];
behaviors.BehaviorB.__super__ = behaviors.AbstractBehavior;
behaviors.BehaviorB.prototype = $extend(behaviors.AbstractBehavior.prototype,{
	createSideAnimationLeft: function() {
		if(this._monster.getArmorHitCount() == 1) this._monster.showBehavior("runSideLeftOn",true); else this._monster.showBehavior("runSide",true);
		this._monster.displaySideTickleSpot();
		this._monster.set_scaleX(1);
		motion.Actuate.tween(this._monster,this._speed,{ x : this.randomRange(100,250)}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.createFrontAnimationB));
	}
	,__class__: behaviors.BehaviorB
});
behaviors.BehaviorC = function(monster,door,scoreBoard,main) {
	behaviors.AbstractBehavior.call(this,monster,door,scoreBoard,main);
	this._speed = 1.3;
};
$hxClasses["behaviors.BehaviorC"] = behaviors.BehaviorC;
behaviors.BehaviorC.__name__ = ["behaviors","BehaviorC"];
behaviors.BehaviorC.__super__ = behaviors.AbstractBehavior;
behaviors.BehaviorC.prototype = $extend(behaviors.AbstractBehavior.prototype,{
	createFrontAnimation: function() {
		var xPos = this.randomRange(100,900);
		this._monster.displayFrontTickleSpot();
		this._monster.showBehavior("runfront");
		motion.Actuate.tween(this._monster.getChildAt(0),this._speed,{ scaleX : 1.25, scaleY : 1.25});
		motion.Actuate.tween(this._monster,this._speed,{ x : xPos, y : 675}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.randomDirection));
	}
	,createFrontAnimationB: function() {
		this.playSound("sound11");
		var xPos = this.randomRange(100,900);
	...
	,hitTickleSpot: function() {
		if(this._scoreBoard.getTickleHitCount() == 2) motion.Actuate.pause(this._monster); else this.pauseMotion(3);
		this._scoreBoard.addTickleHit();
		this.playSound("sound7");
	}
	,runOutDoor: function() {
		this._monster.displaySideTickleSpot();
		this._monster.set_x(1150);
		this._monster.set_y(600);
		this._monster.set_scaleX(1);
		this._monster.set_scaleY(1);
		this._monster.getChildAt(0).set_scaleX(.6);
		this._monster.getChildAt(0).set_scaleY(.6);
		this._monster.showBehavior("runfront");
		var delayTime = this.randomRange(1,9) * .1 + 1;
		motion.Actuate.tween(this._monster,1,{ x : 500, y : 600}).onComplete($bind(this,this.createFrontAnimation)).ease(motion.easing.Quad.get_easeOut()).delay(delayTime);
	}
	,openDoor: function() {
	}
	,closeDoor: function() {
	...
	,__class__: behaviors.BehaviorC
});
var cards = {};
cards.CardManager = function(main) {
	this._lostB = new openfl.display.Sprite();
	this._lostA = new openfl.display.Sprite();
	this._cardLev4 = new openfl.display.Sprite();
	this._cardLev3 = new openfl.display.Sprite();
	this._cardLev2 = new openfl.display.Sprite();
	this._cardLev1 = new openfl.display.Sprite();
	this._freakyBeastsTitle = new openfl.display.Sprite();
	this._main = main;
	this.createFreakyBeasts();
	this.createLevelTwoCard();
	this.createLevelThreeCard();
	this.createLevelFourCard();
	this.createLostCardA();
	this.createLostCardB();
	this.createLevelOneCard();
};
$hxClasses["cards.CardManager"] = cards.CardManager;
cards.CardManager.__name__ = ["cards","CardManager"];
cards.CardManager.prototype = {
	showFreakyBeasts: function() {
		motion.Actuate.tween(this._freakyBeastsTitle,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut());
		this._cardLev1.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.showLevelOneCard));
		this._cardLev1.addEventListener("touchBegin",$bind(this,this.showLevelOneCard));
	}
	,showLevelOneCard: function(e) {
		this._cardLev1.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.showLevelOneCard));
		this._cardLev1.removeEventListener("touchBegin",$bind(this,this.showLevelOneCard));
		this._main.playMusic(true);
		motion.Actuate.tween(this._freakyBeastsTitle,1,{ alpha : 0}).ease(motion.easing.Quad.get_easeOut());
		motion.Actuate.tween(this._cardLev1,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut()).delay(1);
		motion.Actuate.timer(4).onComplete($bind(this,this.fadeOut));
	}
	,fadeOut: function() {
		motion.Actuate.tween(this._cardLev1,1,{ alpha : 0}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.startGame));
	}
	,startGame: function() {
		this._main.playMusic();
		this._main.restartLevel(null);
	}
	,showLevelTwoCard: function() {
		this._main.playMusic(true);
		motion.Actuate.tween(this._cardLev2,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut()).delay(1);
		motion.Actuate.timer(5).onComplete($bind(this,this.fadeOut2));
	}
	,fadeOut2: function() {
		motion.Actuate.tween(this._cardLev2,1,{ alpha : 0}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.startNextLevel));
	}
	,startNextLevel: function() {
		this._main.playMusic();
		this._main.startNextLevel(null);
	}
	,restartLevel: function() {
		this._main.playMusic();
		this._main.restartLevel(null);
	}
	,showLevelThreeCard: function() {
		this._main.playMusic(true);
		motion.Actuate.tween(this._cardLev3,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut()).delay(1);
		motion.Actuate.timer(5).onComplete($bind(this,this.fadeOut3));
	}
	,fadeOut3: function() {
		motion.Actuate.tween(this._cardLev3,1,{ alpha : 0}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.startNextLevel));
	}
	,showLevelFourCard: function() {
		this._main.playMusic(true);
		motion.Actuate.tween(this._cardLev4,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut());
	}
	,showYouLost: function() {
		this._main.playMusic(true);
		motion.Actuate.tween(this._lostA,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut());
		motion.Actuate.timer(5).onComplete($bind(this,this.fadeOutLost));
	}
	,fadeOutLost: function() {
		this._main.clearLevel();
		motion.Actuate.tween(this._lostA,1,{ alpha : 0}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.restartLevel));
	}
	,showYouLostB: function() {
		this._main.playMusic(true);
		motion.Actuate.tween(this._lostB,1,{ alpha : 1}).ease(motion.easing.Quad.get_easeOut());
		motion.Actuate.timer(5).onComplete($bind(this,this.fadeOutLostB));
	}
	,fadeOutLostB: function() {
		this._main.clearLevel();
		motion.Actuate.tween(this._lostB,1,{ alpha : 0}).ease(motion.easing.Quad.get_easeOut()).onComplete($bind(this,this.restartLevel));
	}
	,createFreakyBeasts: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/cards/freakyBeasts.jpg");
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.smoothing = true;
		this._freakyBeastsTitle.addChild(bitmap);
		this._main.getCardHolder().addChild(this._freakyBeastsTitle);
		this._freakyBeastsTitle.set_alpha(0);
	}
	,createLevelOneCard: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/cards/monsterCard.jpg");
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.smoothing = true;
		this._cardLev1.addChild(bitmap);
		this._main.getCardHolder().addChild(this._cardLev1);
		this._cardLev1.set_alpha(0);
	}
	,createLostCardA: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/cards/youLostA.jpg");
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.smoothing = true;
		this._lostA.addChild(bitmap);
		this._main.getCardHolder().addChild(this._lostA);
		this._lostA.set_alpha(0);
	}
	,createLostCardB: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/cards/youLostB.jpg");
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.smoothing = true;
		this._lostB.addChild(bitmap);
		this._main.getCardHolder().addChild(this._lostB);
		this._lostB.set_alpha(0);
	}
	,createLevelTwoCard: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/cards/level2.jpg");
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.smoothing = true;
		this._cardLev2.addChild(bitmap);
		this._main.getCardHolder().addChild(this._cardLev2);
		this._cardLev2.set_alpha(0);
	}
	,createLevelThreeCard: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/cards/level3.jpg");
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.smoothing = true;
		this._cardLev3.addChild(bitmap);
		this._main.getCardHolder().addChild(this._cardLev3);
		this._cardLev3.set_alpha(0);
	}
	,createLevelFourCard: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/cards/youWonB.jpg");
		var bitmap = new openfl.display.Bitmap(bitmapData);
		bitmap.set_width(1024);
		bitmap.set_height(768);
		bitmap.smoothing = true;
		this._cardLev4.addChild(bitmap);
		this._main.getCardHolder().addChild(this._cardLev4);
		this._cardLev4.set_alpha(0);
	}
	,__class__: cards.CardManager
};
var haxe = {};
...
var monsters = {};
monsters.AbstractMonster = function() {
	this.lastTime = 10;
	this._monster = new openfl.display.Sprite();
	this._tickleWrongSpot = new openfl.display.Sprite();
	this._tickleSpot2 = new openfl.display.Sprite();
	this._tickleSpot = new openfl.display.Sprite();
	openfl.display.Sprite.call(this);
	this.loadSounds();
	this.createSpriteSheet();
	this.createMonster();
};
$hxClasses["monsters.AbstractMonster"] = monsters.AbstractMonster;
monsters.AbstractMonster.__name__ = ["monsters","AbstractMonster"];
monsters.AbstractMonster.__super__ = openfl.display.Sprite;
monsters.AbstractMonster.prototype = $extend(openfl.display.Sprite.prototype,{
	reset: function() {
	}
	...
	,showBehavior: function(type,rest) {
		if(rest == null) rest = true;
		this._currentBehavior = type;
		this.animated.showBehavior(this._currentBehavior,rest);
	}
	...
	,loadSounds: function() {
		this._hitSounds = new Array();
		this._hitSounds.push(openfl.Assets.getSound("sound1"));
		this._hitSounds.push(openfl.Assets.getSound("sound2"));
		this._hitSounds.push(openfl.Assets.getSound("sound3"));
		this._missedSounds = new Array();
		this._missedSounds.push(openfl.Assets.getSound("sound4"));
		this._missedSounds.push(openfl.Assets.getSound("sound5"));
	}
	,randomRange: function(minNum,maxNum) {
		return Math.floor(Math.random() * (maxNum - minNum + 1)) + minNum;
	}
	,playMissedSound: function(isEndSound) {
		if(isEndSound == null) isEndSound = false;
		var sound;
		if(isEndSound) sound = this._missedSounds[1]; else sound = this._missedSounds[0];
		sound.play();
	}
	,playHitSound: function(count) {
		var sound = this._hitSounds[count];
		sound.play();
	}
	,getArmorHitCount: function() {
		return 0;
	}
	,createMonster: function() {
		this._holder = new openfl.display.Sprite();
		this._holder.addChild(this.animated);
		this._holder.addChild(this._tickleWrongSpot);
		this._holder.addChild(this._tickleSpot);
		this._holder.addChild(this._tickleSpot2);
		this._holder.set_y(-275);
		this._holder.set_x(-175);
		this._monster.addChild(this._holder);
		this.addChild(this._monster);
		this.createTickleWrongSpot();
		this.createTickleSpotFront();
		this.createTickleSpot2Front();
	}
	,createTickleWrongSpot: function() {
		this._tickleWrongSpot.get_graphics().beginFill(65280);
		this._tickleWrongSpot.get_graphics().drawCircle(170,200,110);
		this._tickleWrongSpot.get_graphics().endFill();
		this._tickleWrongSpot.set_scaleX(.6);
		this._tickleWrongSpot.set_x(60);
		this._tickleWrongSpot.set_y(20);
		this._tickleWrongSpot.set_alpha(0);
		this._tickleWrongSpot.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.onClickWrongSpot));
		this._tickleWrongSpot.addEventListener("touchBegin",$bind(this,this.onClickWrongSpot));
	}
	,onClickWrongSpot: function(event) {
		var count = this._behavior.getScoreBooard().gettWrongSpotHit();
		if(count >= 2) {
			this.showBitAnimation();
			this.hideTickleSpot();
			this.playMissedSound(true);
			this._behavior.missedTickleSpot();
		} else {
			this.animated.showBehavior("roar");
			this.hideTickleSpot();
			this.playMissedSound();
			this._behavior.missedTickleSpot();
		}
	}
	,createTickleSpotFront: function() {
		this._tickleSpot.get_graphics().beginFill(16711680);
		this._tickleSpot.get_graphics().drawCircle(180,225,30);
		this._tickleSpot.get_graphics().endFill();
		this._tickleSpot.set_alpha(0);
		this._tickleSpot.set_scaleX(.6);
		this._tickleSpot.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.onClickTickleSpot));
		this._tickleSpot.addEventListener("touchBegin",$bind(this,this.onClickTickleSpot));
	}
	,createTickleSpot2Front: function() {
		this._tickleSpot2.get_graphics().beginFill(16755200);
		this._tickleSpot2.get_graphics().drawCircle(375,225,30);
		this._tickleSpot2.get_graphics().endFill();
		this._tickleSpot2.set_alpha(0);
		this._tickleSpot2.set_scaleX(.6);
		this._tickleSpot2.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.onClickTickleSpot));
		this._tickleSpot2.addEventListener("touchBegin",$bind(this,this.onClickTickleSpot));
		this.displaySideTickleSpot();
	}
	,displaySideTickleSpot: function() {
		this._tickleSpot.set_visible(true);
		this._tickleSpot2.set_visible(true);
		this._tickleWrongSpot.set_visible(true);
		this._tickleSpot.set_x(70);
		this._tickleSpot2.set_x(-45);
	}
	,displayFrontTickleSpot: function() {
		this._tickleSpot.set_visible(true);
		this._tickleSpot2.set_visible(true);
		this._tickleWrongSpot.set_visible(true);
		this._tickleSpot.set_x(0);
		this._tickleSpot2.set_x(0);
	}
	,hideTickleSpot: function() {
		this._tickleSpot.set_visible(false);
		this._tickleSpot2.set_visible(false);
		this._tickleWrongSpot.set_visible(false);
	}
	,onClickTickleSpot: function(event) {
		var tickleHitCount = this._behavior.getScoreBooard().getTickleHitCount();
		if(tickleHitCount == 2) this.animated.showBehavior("laugh"); else this.animated.showBehavior("tickle");
		this.hideTickleSpot();
		this.playHitSound(tickleHitCount);
		this._behavior.hitTickleSpot();
	}
	,createSpriteSheet: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/monsterAnimation18.png");
		var spritesheet1 = spritesheet.importers.BitmapImporter.create(bitmapData,6,5,363,440);
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("roar",[0,1,2,3,4],true,7));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("tickle",[5,6,7,8,9],true,7));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runfront",[10,11,12,13,14,15,16],true,12));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runSide",[17,18,19,20,21],true,12));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("laugh",[22,23,24,25,26,27],true,7));
		this.animated = new spritesheet.AnimatedSprite(spritesheet1,true);
		this.showBehavior("runfront");
	}
	,showBitAnimation: function() {
		this.removeAnimated();
		var bitmapData = openfl.Assets.getBitmapData("assets/monsterAnimation22.png");
		var spritesheet1 = spritesheet.importers.BitmapImporter.create(bitmapData,2,2,400,430);
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("bit",[0,1,2],false,6));
		this.animated = new spritesheet.AnimatedSprite(spritesheet1,true);
		this._holder.addChild(this.animated);
		this.showBehavior("bit");
		motion.Actuate.tween(this.animated,.8,{ scaleX : 1.5, scaleY : 1.5, y : -500, x : -100}).delay(.2).onComplete($bind(this,this.bitMe));
	}
	,removeAnimated: function() {
		while(this.animated.get_numChildren() > 0) this.animated.removeChildAt(0);
		this._holder.removeChild(this.animated);
	}
	,bitMe: function() {
		this._bitmapMonsterFace = new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/cards/monsterFace.jpg"));
		this._bitmapMonsterFace.set_scaleX(.5);
		this._bitmapMonsterFace.set_scaleY(.5);
		this._behavior.getMain().addChild(this._bitmapMonsterFace);
		motion.Actuate.timer(3).onComplete($bind(this,this.removeBit));
		this.reset();
	}
	,removeBit: function() {
		this.removeAnimated();
		this._behavior.getMain().removeChild(this._bitmapMonsterFace);
		motion.Actuate.stop(this,null,false,false);
	}
	,__class__: monsters.AbstractMonster
});
monsters.MonsterA = function() {
	monsters.AbstractMonster.call(this);
};
$hxClasses["monsters.MonsterA"] = monsters.MonsterA;
monsters.MonsterA.__name__ = ["monsters","MonsterA"];
monsters.MonsterA.__super__ = monsters.AbstractMonster;
monsters.MonsterA.prototype = $extend(monsters.AbstractMonster.prototype,{
	__class__: monsters.MonsterA
});
monsters.MonsterB = function() {
	this._armorHitCount = 0;
	this._isArmorOff = false;
	monsters.AbstractMonster.call(this);
};
$hxClasses["monsters.MonsterB"] = monsters.MonsterB;
monsters.MonsterB.__name__ = ["monsters","MonsterB"];
monsters.MonsterB.__super__ = monsters.AbstractMonster;
monsters.MonsterB.prototype = $extend(monsters.AbstractMonster.prototype,{
	reset: function() {
		this._isArmorOff = false;
		this._armorHitCount = 0;
	}
	,getArmorHitCount: function() {
		return this._armorHitCount;
	}
	,showBehavior: function(type,rest) {
		if(rest == null) rest = true;
		if(this._isArmorOff == false) {
			if(type == "runSideLeftOn") this._currentBehavior = "runSide0"; else this._currentBehavior = "" + type + this._armorHitCount;
			if(this._currentBehavior == "runSide2") this._currentBehavior = "runSide1";
		} else this._currentBehavior = type;
		this.animated.showBehavior(this._currentBehavior,rest);
	}
	,onClickWrongSpot: function(event) {
		if(this._isArmorOff) monsters.AbstractMonster.prototype.onClickWrongSpot.call(this,event); else this.removeArmor();
	}
	,onClickTickleSpot: function(event) {
		if(this._isArmorOff) monsters.AbstractMonster.prototype.onClickTickleSpot.call(this,event); else this.removeArmor();
	}
	,removeArmor: function() {
		if(this._armorBehavior == null) {
			this._armorBehavior = new behaviors.ArmorBehavior();
			this._armorBehavior.set_y(175);
			this._armorBehavior.set_x(150);
			this._holder.addChild(this._armorBehavior);
		}
		if(this._armorHitCount == 0) {
			this._armorHitCount++;
			motion.Actuate.stop(this._monster,null,false,false);
			this._behavior.createSideAnimationRight();
			this._armorBehavior.removeArm();
		} else if(this._armorHitCount == 1) {
			this._armorHitCount++;
			motion.Actuate.stop(this._monster,null,false,false);
			this._behavior.createSideAnimationLeft();
			this._armorBehavior.removeArm();
		} else if(this._armorHitCount == 2) {
			this._isArmorOff = true;
			motion.Actuate.stop(this._monster,null,false,false);
			this.showAllArmorOffAnimation();
			this._behavior.createFrontAnimationB();
			this._armorBehavior.removeBody();
		}
		var sound = openfl.Assets.getSound("sound6");
		sound.play();
	}
	,createSpriteSheet: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/monsterAnimationArmorC.png");
		var spritesheet1 = spritesheet.importers.BitmapImporter.create(bitmapData,7,5,304,440);
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runfront0",[0,1,2,3,4,5,6],true,12));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runfront1",[7,8,9,10,11,12,13],true,12));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runfront2",[14,15,16,17,18,19,20],true,12));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runSide0",[21,22,23,24,25],true,12));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runSide1",[26,27,28,29,30],true,12));
		this.animated = new spritesheet.AnimatedSprite(spritesheet1,true);
	}
	,showAllArmorOffAnimation: function() {
		this.removeAnimated();
		var bitmapData = openfl.Assets.getBitmapData("assets/monsterAnimation18.png");
		var spritesheet1 = spritesheet.importers.BitmapImporter.create(bitmapData,6,5,363,440);
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("roar",[0,1,2,3,4],true,7));
		...
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("laugh",[22,23,24,25,26,27],true,7));
		this.animated = new spritesheet.AnimatedSprite(spritesheet1,true);
		this._holder.addChildAt(this.animated,0);
		this.showBehavior(this._currentBehavior);
	}
	,__class__: monsters.MonsterB
});
monsters.MonsterC = function() {
	monsters.AbstractMonster.call(this);
};
$hxClasses["monsters.MonsterC"] = monsters.MonsterC;
monsters.MonsterC.__name__ = ["monsters","MonsterC"];
monsters.MonsterC.__super__ = monsters.AbstractMonster;
monsters.MonsterC.prototype = $extend(monsters.AbstractMonster.prototype,{
	createSpriteSheet: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/spaceMonsterAnimation7.png");
		var spritesheet1 = spritesheet.importers.BitmapImporter.create(bitmapData,5,6,422,370);
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("roar",[15,16,17,18,19,20],true,7));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runfront",[0,1,2,3,4,5,6,7],true,11));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("tickle",[21,22,23,24,25],true,7));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("runSide",[8,9,10,11,12,13,14],true,11));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("laugh",[21,22,23,24,25],true,11));
		this.animated = new spritesheet.AnimatedSprite(spritesheet1,true);
		this.animated.set_scaleX(.8);
		this.animated.set_scaleY(.8);
		this.showBehavior("runfront");
	}
	,loadSounds: function() {
		this._hitSounds = new Array();
		this._hitSounds.push(openfl.Assets.getSound("sound13"));
		this._hitSounds.push(openfl.Assets.getSound("sound13"));
		this._hitSounds.push(openfl.Assets.getSound("sound15"));
		this._missedSounds = new Array();
		this._missedSounds.push(openfl.Assets.getSound("sound14"));
		this._missedSounds.push(openfl.Assets.getSound("sound16"));
	}
	,createTickleWrongSpot: function() {
		this._tickleWrongSpot.get_graphics().beginFill(65280);
		this._tickleWrongSpot.get_graphics().drawCircle(170,200,85);
		this._tickleWrongSpot.get_graphics().endFill();
		this._tickleWrongSpot.set_scaleX(.6);
		this._tickleWrongSpot.set_x(160);
		this._tickleWrongSpot.set_y(-25);
		this._tickleWrongSpot.set_alpha(0);
		this._tickleWrongSpot.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.onClickWrongSpot));
		this._tickleWrongSpot.addEventListener("touchBegin",$bind(this,this.onClickWrongSpot));
	}
	,createTickleSpotFront: function() {
		this._tickleSpot.get_graphics().beginFill(16711680);
		this._tickleSpot.get_graphics().drawCircle(100,200,40);
		this._tickleSpot.get_graphics().endFill();
		this._tickleSpot.set_alpha(0);
		this._tickleSpot.set_rotation(-25);
		this._tickleSpot.set_x(25);
		this._tickleSpot.set_y(40);
		this._tickleSpot.set_scaleX(.6);
		this._tickleSpot.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.onClickTickleSpot));
		this._tickleSpot.addEventListener("touchBegin",$bind(this,this.onClickTickleSpot));
	}
	,createTickleSpot2Front: function() {
		this._tickleSpot2.get_graphics().beginFill(16755200);
		this._tickleSpot2.get_graphics().drawCircle(600,75,40);
		this._tickleSpot2.get_graphics().endFill();
		this._tickleSpot2.set_alpha(0);
		this._tickleSpot2.set_rotation(25);
		this._tickleSpot2.set_scaleX(.6);
		this._tickleSpot2.set_x(-20);
		this._tickleSpot2.set_y(-40);
		this._tickleSpot2.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.onClickTickleSpot));
		this._tickleSpot2.addEventListener("touchBegin",$bind(this,this.onClickTickleSpot));
		this.displaySideTickleSpot();
	}
	,showBitAnimation: function() {
		this.removeAnimated();
		var bitmapData = openfl.Assets.getBitmapData("assets/spaceMonsterJumpAnimation.png");
		var spritesheet1 = spritesheet.importers.BitmapImporter.create(bitmapData,3,1,560,600);
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("bit",[0,1,2],false,6));
		this.animated = new spritesheet.AnimatedSprite(spritesheet1,true);
		this._holder.addChild(this.animated);
		this.showBehavior("bit");
	...
	,bitMe: function() {
		this._bitmapMonsterFace = new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/cards/monster2FullFace.jpg"));
		this._bitmapMonsterFace.set_scaleX(.5);
		this._bitmapMonsterFace.set_scaleY(.5);
		this._behavior.getMain().addChild(this._bitmapMonsterFace);
		motion.Actuate.timer(3).onComplete($bind(this,this.removeBit));
	...
	,displayFrontTickleSpot: function() {
		...
		this._tickleSpot2.set_visible(true);
		this._tickleWrongSpot.set_visible(true);
		this._tickleWrongSpot.set_x(100);
	}
	,displaySideTickleSpot: function() {
		this._tickleSpot.set_visible(false);
		this._tickleSpot2.set_visible(false);
		this._tickleWrongSpot.set_visible(true);
		this._tickleWrongSpot.set_x(80);
	}
	,removeBit: function() {
		this.reset();
		this.removeAnimated();
...
var points = {};
points.PointDisplay = function(id) {
	openfl.display.Sprite.call(this);
	this._bmp = new openfl.display.Bitmap(new openfl.display.BitmapData(50,40,false,-1));
	this.addChild(this._bmp);
	this._bmp.set_alpha(1);
	this._bmpIcon = new openfl.display.Bitmap(new openfl.display.BitmapData(50,40,false,-1285725));
	this._bmpIcon.set_alpha(.0);
	this.addChild(this._bmpIcon);
};
$hxClasses["points.PointDisplay"] = points.PointDisplay;
points.PointDisplay.__name__ = ["points","PointDisplay"];
points.PointDisplay.__super__ = openfl.display.Sprite;
points.PointDisplay.prototype = $extend(openfl.display.Sprite.prototype,{
	reset: function() {
		this._bmpIcon.set_alpha(.0);
		this._bmp.set_alpha(1);
	}
	,showWonPoint: function() {
		motion.Actuate.tween(this._bmpIcon,1,{ alpha : 1});
		motion.Actuate.tween(this._bmp,1,{ alpha : 1});
	}
	,__class__: points.PointDisplay
});
points.PowerDisplay = function() {
	openfl.display.Sprite.call(this);
	var bmp = new openfl.display.Bitmap(new openfl.display.BitmapData(160,60,false,-1));
	this._barBmp = new openfl.display.Bitmap(new openfl.display.BitmapData(160,60,false,-1285725));
	this._barBmp.set_scaleX(0);
	this.addChild(bmp);
	this.addChild(this._barBmp);
};
$hxClasses["points.PowerDisplay"] = points.PowerDisplay;
points.PowerDisplay.__name__ = ["points","PowerDisplay"];
points.PowerDisplay.__super__ = openfl.display.Sprite;
points.PowerDisplay.prototype = $extend(openfl.display.Sprite.prototype,{
	hit: function() {
		var _g = this._barBmp;
		_g.set_scaleX(_g.get_scaleX() + .33);
	}
	,reset: function() {
		this._barBmp.set_scaleX(0);
	}
	,__class__: points.PowerDisplay
});
points.Scoreboard = function(main) {
	this._wrongSpotHit = 0;
	this._tickleHit = 0;
	this._main = main;
	this.createScoreDisplay(main);
	this.createPowerDisplay(main);
	this.createMonsterDisplay(main);
};
$hxClasses["points.Scoreboard"] = points.Scoreboard;
points.Scoreboard.__name__ = ["points","Scoreboard"];
points.Scoreboard.prototype = {
	createMonsterDisplay: function(main) {
		var monster = new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/icons/monsterAnimationScore.png"));
		monster.set_scaleX(.5);
		monster.set_scaleY(.5);
		monster.smoothing = true;
		main.getGameHolder().addChild(monster);
	}
	,createPowerDisplay: function(main) {
		this._powerDisplay = new points.PowerDisplay();
		main.getGameHolder().addChild(this._powerDisplay);
		this._powerDisplay.set_x(157);
		this._powerDisplay.set_y(160);
	}
	,createScoreDisplay: function(main) {
		this._point1 = new points.PointDisplay(0);
		this._point2 = new points.PointDisplay(1);
		this._point3 = new points.PointDisplay(2);
		main.getGameHolder().addChild(this._point1);
		main.getGameHolder().addChild(this._point2);
		main.getGameHolder().addChild(this._point3);
		this._point1.set_y(this._point2.set_y(this._point3.set_y(110)));
		this._point1.set_x(155);
		this._point2.set_x(this._point1.get_x() + this._point1.get_width() + 6);
		this._point3.set_x(this._point2.get_x() + this._point2.get_width() + 6);
		this._pointArray = [this._point1,this._point2,this._point3];
	}
	,getTickleHitCount: function() {
		return this._tickleHit;
	}
	,gettWrongSpotHit: function() {
		return this._wrongSpotHit;
	}
	,addTickleHit: function() {
		this._tickleHit++;
		this._pointArray.shift().showWonPoint();
		if(this._pointArray.length == 0) motion.Actuate.timer(6).onComplete($bind(this,this.passLevelReset));
	}
	,addWrongSpotHit: function() {
		this._wrongSpotHit++;
		this._powerDisplay.hit();
		if(this._wrongSpotHit >= 3) motion.Actuate.timer(3).onComplete($bind(this,this.gameOverReset));
	}
	,passLevelReset: function() {
		this.reset();
		this._main.passLevel();
	}
	...
	,reset: function() {
		...
		this._wrongSpotHit = 0;
		this._pointArray = [this._point1,this._point2,this._point3];
		this._pointArray[0].reset();
		this._pointArray[1].reset();
		this._pointArray[2].reset();
		this._powerDisplay.reset();
	}
	,__class__: points.Scoreboard
};
var props = {};
props.Door = function() {
	this._lastTime = 10;
	this._door = new openfl.display.Sprite();
	openfl.display.Sprite.call(this);
	this.createSpriteSheet();
	this.createDoor();
};
$hxClasses["props.Door"] = props.Door;
props.Door.__name__ = ["props","Door"];
props.Door.__super__ = openfl.display.Sprite;
props.Door.prototype = $extend(openfl.display.Sprite.prototype,{
	onUpdateFrame: function(e) {
		var time = openfl.Lib.getTimer();
		var delta = time - this._lastTime;
		this._animated.update(delta);
		this._lastTime = time;
	}
	,createDoor: function() {
		var holder = new openfl.display.Sprite();
		holder.addChild(this._animated);
		holder.set_scaleX(.5);
		holder.set_scaleY(.5);
		holder.set_x(496);
		holder.set_y(236);
		this._door.addChild(holder);
		this.addChild(this._door);
	}
	,createSpriteSheet: function() {
		var bitmapData = openfl.Assets.getBitmapData("assets/door.png");
		var spritesheet1 = spritesheet.importers.BitmapImporter.create(bitmapData,2,3,350,681);
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("open",[0,1,2,3,4,5],false,16));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("close",[5,4,3,2,1,0],false,24));
		spritesheet1.addBehavior(new spritesheet.data.BehaviorData("closeState",[0],false,1));
		this._animated = new spritesheet.AnimatedSprite(spritesheet1,true);
		this._animated.showBehavior("closeState");
	}
	,showBehavior: function(type,rest) {
		if(rest == null) rest = true;
		this._animated.showBehavior(type,rest);
	}
	,__class__: props.Door
});
var spritesheet = {};
