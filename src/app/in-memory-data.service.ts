    ...
    let gallery = [
      ...
      },
      {
        ...
        description: [ "Truth Ad Campaign",
          "The Truth #Squadless campaign focuses on the fact that people who habitually smoke cigarettes have significantly less cash than people who don't. My job was to program the mobile ads and keep the feel of animation consistent with the video ad the campaign. I use JavaScript and CSS3 for the animation. Sublime Text 2 was my IDE of choice. Chrome Dev Tools was also an important part of the development process.",
          "Technology",
          ["JavaScript", "HTML5", "CSS3", "SASS", "Gulp"]],
